...
contract MetaMultiSigWallet {
    ...
    event FundTransfered(address indexed to, uint value);
    ...
    function addSigner(address newSigner, uint256 newSignaturesRequired) public onlySelf {
        ...
        require(!isOwner[newSigner], "addSigner: not owner");
    ...
    function transferFunds(address to, uint256 value) public onlySelf {
        require(to != address(0), "transferFunds: zero address");
        require(value > 0, "transferFunds: must be non-zero value");
        (bool sent, ) = to.call{value:value}("");
        require(sent, "transfer funds failed");
        emit FundTransfered(to, value);
    }
